...
import classes from './ModelTrainedComplete.scss'
...
export class ModelTrainedComplete extends React.Component {
  props: Props;
  constructor (props) {
    super(props)
    this.state = {}
  ...
  render () {
    ...
    return (
      <div className={classes['ModelTrainedComplete-container']}>
